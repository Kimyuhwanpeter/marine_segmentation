...
def parallel_Unet(input_shape=(352, 352, 3), nclasses=1, train=True):
    ...
    temp_h_1 = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_h_1, tf.float32)) - tf.cast(h_1_f, tf.float32))
    temp_h_1 = tf.keras.layers.ReLU()(temp_h_1)
    temp_h_1_f = tf.nn.sigmoid(h_1) * h_1_f
    temp_h_1_f = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_h_1_f, tf.float32)) - tf.cast(h_1, tf.float32))
    ...
    temp_h_2 = (tf.keras.layers.AvgPool2D((16, 16), strides=1, padding="same")(tf.cast(temp_h_2, tf.float32)) - tf.cast(h_2_f, tf.float32))
    temp_h_2 = tf.keras.layers.ReLU()(temp_h_2)
    temp_h_2_f = tf.nn.sigmoid(h_2) * h_2_f
    temp_h_2_f = (tf.keras.layers.AvgPool2D((16, 16), strides=1, padding="same")(tf.cast(temp_h_2_f, tf.float32)) - tf.cast(h_2, tf.float32))
    ...
    temp_h_3 = (tf.keras.layers.AvgPool2D((8, 8), strides=1, padding="same")(tf.cast(temp_h_3, tf.float32)) - tf.cast(h_3_f, tf.float32))
    temp_h_3 = tf.keras.layers.ReLU()(temp_h_3)
    temp_h_3_f = tf.nn.sigmoid(h_3) * h_3_f
    temp_h_3_f = (tf.keras.layers.AvgPool2D((8, 8), strides=1, padding="same")(tf.cast(temp_h_3_f, tf.float32)) - tf.cast(h_3, tf.float32))
    ...
    temp_h_4 = (tf.keras.layers.AvgPool2D((4, 4), strides=1, padding="same")(tf.cast(temp_h_4, tf.float32)) - tf.cast(h_4_f, tf.float32))
    temp_h_4 = tf.keras.layers.ReLU()(temp_h_4)
    temp_h_4_f = tf.nn.sigmoid(h_4) * h_4_f
    temp_h_4_f = (tf.keras.layers.AvgPool2D((4, 4), strides=1, padding="same")(tf.cast(temp_h_4_f, tf.float32)) - tf.cast(h_4, tf.float32))
    ...
    temp_h_5 = (tf.keras.layers.AvgPool2D((2, 2), strides=1, padding="same")(tf.cast(temp_h_5, tf.float32)) - tf.cast(h_5_f, tf.float32))
    temp_h_5 = tf.keras.layers.ReLU()(temp_h_5)
    temp_h_5_f = tf.nn.sigmoid(h_5) * h_5_f
    temp_h_5_f = (tf.keras.layers.AvgPool2D((2, 2), strides=1, padding="same")(tf.cast(temp_h_5_f, tf.float32)) - tf.cast(h_5, tf.float32))
    ...
    temp_center_block_conv1 = (tf.keras.layers.AvgPool2D((2, 2), strides=1, padding="same")(tf.cast(temp_center_block_conv1, tf.float32)) - tf.cast(center_block_conv1_f, tf.float32))
    ...
    temp_center_block_conv1_f = (tf.keras.layers.AvgPool2D((2, 2), strides=1, padding="same")(tf.cast(temp_center_block_conv1_f, tf.float32)) - tf.cast(center_block_conv1, tf.float32))
    ...
    temp_center_block_conv2 = (tf.keras.layers.AvgPool2D((4, 4), strides=1, padding="same")(tf.cast(temp_center_block_conv2, tf.float32)) - tf.cast(center_block_conv2_f, tf.float32))
    ...
    temp_center_block_conv2_f = (tf.keras.layers.AvgPool2D((4, 4), strides=1, padding="same")(tf.cast(temp_center_block_conv2_f, tf.float32)) - tf.cast(center_block_conv2, tf.float32))
    ...
    temp_center_block_conv3 = (tf.keras.layers.AvgPool2D((8, 8), strides=1, padding="same")(tf.cast(temp_center_block_conv3, tf.float32)) - tf.cast(center_block_conv3_f, tf.float32))
    ...
    temp_center_block_conv3_f = (tf.keras.layers.AvgPool2D((8, 8), strides=1, padding="same")(tf.cast(temp_center_block_conv3_f, tf.float32)) - tf.cast(center_block_conv3, tf.float32))
    ...
    temp_center_block_conv4 = (tf.keras.layers.AvgPool2D((16, 16), strides=1, padding="same")(tf.cast(temp_center_block_conv4, tf.float32)) - tf.cast(center_block_conv4_f, tf.float32))
    ...
    temp_center_block_conv4_f = (tf.keras.layers.AvgPool2D((16, 16), strides=1, padding="same")(tf.cast(temp_center_block_conv4_f, tf.float32)) - tf.cast(center_block_conv4, tf.float32))
    ...
    temp_center_block_conv5 = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_center_block_conv5, tf.float32)) - tf.cast(center_block_conv5_f, tf.float32))
    ...
    temp_center_block_conv5_f = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_center_block_conv5_f, tf.float32)) - tf.cast(center_block_conv5, tf.float32))
    ...
    temp_center_block_conv6 = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_center_block_conv6, tf.float32)) - tf.cast(center_block_conv6_f, tf.float32))
    ...
    temp_center_block_conv6_f = (tf.keras.layers.AvgPool2D((32, 32), strides=1, padding="same")(tf.cast(temp_center_block_conv6_f, tf.float32)) - tf.cast(center_block_conv6, tf.float32))
    ...
    object_model.load_weights('C:/Users/Yuhwan/Downloads/model_object.h5')
    
    model.get_layer('block1_conv1').set_weights(object_model.get_layer('block1_conv1').get_weights())
    model.get_layer('block1_conv1_f').set_weights(object_model.get_layer('block1_conv1').get_weights())

    model.get_layer('block1_conv2').set_weights(object_model.get_layer('block1_conv2').get_weights())
    model.get_layer('block1_conv2_f').set_weights(object_model.get_layer('block1_conv2').get_weights())
    
    model.get_layer('block2_conv1').set_weights(object_model.get_layer('block2_conv1').get_weights())
    model.get_layer('block2_conv1_f').set_weights(object_model.get_layer('block2_conv1').get_weights())
    
    model.get_layer('block2_conv2').set_weights(object_model.get_layer('block2_conv2').get_weights())
    model.get_layer('block2_conv2_f').set_weights(object_model.get_layer('block2_conv2').get_weights())
    
    model.get_layer('block3_conv1').set_weights(object_model.get_layer('block3_conv1').get_weights())
    model.get_layer('block3_conv1_f').set_weights(object_model.get_layer('block3_conv1').get_weights())
    
    model.get_layer('block3_conv2').set_weights(object_model.get_layer('block3_conv2').get_weights())
    model.get_layer('block3_conv2_f').set_weights(object_model.get_layer('block3_conv2').get_weights())
    
    model.get_layer('block3_conv3').set_weights(object_model.get_layer('block3_conv3').get_weights())
    model.get_layer('block3_conv3_f').set_weights(object_model.get_layer('block3_conv3').get_weights())
    
    model.get_layer('block4_conv1').set_weights(object_model.get_layer('block4_conv1').get_weights())
    model.get_layer('block4_conv1_f').set_weights(object_model.get_layer('block4_conv1').get_weights())
    
    model.get_layer('block4_conv2').set_weights(object_model.get_layer('block4_conv2').get_weights())
    model.get_layer('block4_conv2_f').set_weights(object_model.get_layer('block4_conv2').get_weights())
    
    model.get_layer('block4_conv3').set_weights(object_model.get_layer('block4_conv3').get_weights())
    model.get_layer('block4_conv3_f').set_weights(object_model.get_layer('block4_conv3').get_weights())
    
    model.get_layer('block5_conv1').set_weights(object_model.get_layer('block5_conv1').get_weights())
    model.get_layer('block5_conv1_f').set_weights(object_model.get_layer('block5_conv1').get_weights())
    
    model.get_layer('block5_conv2').set_weights(object_model.get_layer('block5_conv2').get_weights())
    model.get_layer('block5_conv2_f').set_weights(object_model.get_layer('block5_conv2').get_weights())
    
    model.get_layer('block5_conv3').set_weights(object_model.get_layer('block5_conv3').get_weights())
    model.get_layer('block5_conv3_f').set_weights(object_model.get_layer('block5_conv3').get_weights())

    model.get_layer('center_conv1').set_weights(object_model.get_layer('center_block1_conv').get_weights())
    model.get_layer('center_conv2').set_weights(object_model.get_layer('center_block2_conv').get_weights())

    model.get_layer('center_conv1_f').set_weights(object_model.get_layer('center_block1_conv').get_weights())
    model.get_layer('center_conv2_f').set_weights(object_model.get_layer('center_block2_conv').get_weights())

    model.get_layer('deconv1').set_weights(object_model.get_layer('decoder_stage0a_transpose').get_weights())
    model.get_layer('center_conv3').set_weights(object_model.get_layer('decoder_stage0b_conv').get_weights())

    model.get_layer('deconv1_f').set_weights(object_model.get_layer('decoder_stage0a_transpose').get_weights())
    model.get_layer('center_conv3_f').set_weights(object_model.get_layer('decoder_stage0b_conv').get_weights())

    model.get_layer('deconv2').set_weights(object_model.get_layer('decoder_stage1a_transpose').get_weights())
    model.get_layer('center_conv4').set_weights(object_model.get_layer('decoder_stage1b_conv').get_weights())

    model.get_layer('deconv2_f').set_weights(object_model.get_layer('decoder_stage1a_transpose').get_weights())
    model.get_layer('center_conv4_f').set_weights(object_model.get_layer('decoder_stage1b_conv').get_weights())

    model.get_layer('deconv3').set_weights(object_model.get_layer('decoder_stage2a_transpose').get_weights())
    model.get_layer('center_conv5').set_weights(object_model.get_layer('decoder_stage2b_conv').get_weights())

    model.get_layer('deconv3_f').set_weights(object_model.get_layer('decoder_stage2a_transpose').get_weights())
    model.get_layer('center_conv5_f').set_weights(object_model.get_layer('decoder_stage2b_conv').get_weights())

    model.get_layer('deconv4').set_weights(object_model.get_layer('decoder_stage3a_transpose').get_weights())
    model.get_layer('center_conv6').set_weights(object_model.get_layer('decoder_stage3b_conv').get_weights())

    model.get_layer('deconv4_f').set_weights(object_model.get_layer('decoder_stage3a_transpose').get_weights())
    model.get_layer('center_conv6_f').set_weights(object_model.get_layer('decoder_stage3b_conv').get_weights())

    model.get_layer('deconv5').set_weights(object_model.get_layer('decoder_stage4a_transpose').get_weights())
    model.get_layer('center_conv7').set_weights(object_model.get_layer('decoder_stage4b_conv').get_weights())

    model.get_layer('deconv5_f').set_weights(object_model.get_layer('decoder_stage4a_transpose').get_weights())
    model.get_layer('center_conv7_f').set_weights(object_model.get_layer('decoder_stage4b_conv').get_weights())
    return model

from model_profiler import model_profiler
mo = parallel_Unet()
prob = model_profiler(mo, 10)
mo.summary()
print(prob)
